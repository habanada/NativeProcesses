...
namespace ProcessDemo
{
    public partial class RemoteClientForm : Form
    {
            ...
            try
            {
                switch (type)
                {
                    ...
                    case "process_removed":
                        ...
                        break;
                    case "process_volatile_update":
                        var volatileUpdate = JsonConvert.DeserializeObject<ProcessVolatileUpdate>(data);
        ...
        {
            _client.SendMessageAsync("get_all_processes", null);
        }
    }
}