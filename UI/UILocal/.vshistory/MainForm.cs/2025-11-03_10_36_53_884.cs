...
namespace ProcessDemo
{
    public partial class MainForm : Form
    {
        ...
        private void LoadProcesses()
        {
            ...
            // KORREKTE BINDUNG:
            // 1. Die BindingSource (Filter) verweist auf die Master-Liste
            _filteredBindingSource.DataSource = _allProcessItems;

            // 2. Das Grid verweist auf die BindingSource (Filter)
        ...
        private void Service_ProcessAdded(FullProcessInfo info)
        {
            ...
            // Hinzufügen zur Master-Liste (die BindingSource bemerkt dies)
        ...
        private void Service_ProcessRemoved(int pid)
        {
            ...
            {
                // Entfernen aus Master-Liste (die BindingSource bemerkt dies)
