...
namespace ProcessDemo
{
    public partial class MainForm : Form
    {
        ...
        private void LoadProcesses()
        {
            ...
            // ÄNDERUNG: Direkt an die BindingList binden
            _filteredBindingSource.DataSource = _allProcessItems;

            // ÄNDERUNG: Grid an die BindingSource binden
        ...
        private void ApplyFilter()
        {
            ...
            {
                // Ersetzt Sonderzeichen für die Filter-Syntax
                string escapedFilter = filterText.Replace("'", "''").Replace("%", "[%]");

                try
                {
                    // Baut einen LIKE-Filter für die BindingSource
