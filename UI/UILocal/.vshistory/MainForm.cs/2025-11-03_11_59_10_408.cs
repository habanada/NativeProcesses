...
namespace ProcessDemo
{
    public partial class MainForm : Form
    {
        ...
        private void SetupGrid()
        {
            ...
            // ÄNDERUNG: 'Fill' ist viel schneller als 'DisplayedCells' beim Laden.
        ...
        private void LoadProcesses()
        {
         ...
         //   var logger = new ConsoleLogger(richTextBox1);
            _service = new ProcessService(provider, null);

            _allProcessItems = new BindingList<FullProcessInfo>();
            _allProcessItems.ListChanged += Binding_ListChanged;

            // Direkt an BindingList binden, keine BindingSource verwenden
            ...
            // Optional: Titel initialisieren
            this.Text = "Processes: 0";
        }
