...
It acts as the hub and faade for process information management.
...
| **Microsoft.Diagnostics.Tracing.TraceEvent** | Real-time kernel event tracing (ETW) for process start/stop and I/O events |  Optional (for ETW provider) |
| **System.Management** | WMI provider fallback for environments without ETW |  Optional |
